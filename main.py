...
def main():
    ...
    # Truck 1 - leaves right at 8:00AM
    load_1: list = [1, 13, 5, 14, 15, 16, 19, 20, 29, 30, 31, 37, 40]
    delivery_truck_1: Delivery_Truck = Delivery_Truck(load_1, truck_departure_time = dt.timedelta(hours= 8))
    ...
    delivery_truck_3 = Delivery_Truck(load_3, truck_departure_time= dt.timedelta(hours=10, minutes=30)) 
...
# FLOW - Executes main function, 
    # creates user interface to view package status and milage of trucks.
if __name__ == "__main__":
    
    print("*--__-- WGUPS Postal Delivery Service --__--*","\n")
    truck_1, truck_2, truck_3, total_milage = main()
    
    # FLOW - Creating user interface for viewing package status 
        # and total milage with specific truck objects.
    interface = menu(truck_1, truck_2, truck_3, total_milage, 
                     package_hash_table)
    interface.user_menu()
